...
describe('getMerkleRoot', function () {
  ...
  it('should return merkle root of block 100k-1 (odd num of tx)', function () {
    ...
    var expMerkle = '110ed92f558a1e3a94976ddea5c32f030670b5c58c3cc4d857ac14d7a1547a90';
  ...
  it('should return merkle root of block 106022', function () {
    var txs = BLOCK_106022.txs;
    var expMerkle = '9cdf7722eb64015731ba9794e32bdefd9cf69b42456d31f5e59aedb68c57ed52';
...
describe('getTxMerkle', function () {
  describe('for block 100k', function () {
    it('tx[0]', function () {
      ...
      var merkle = btcProof.getTxMerkle(proof);
      assert.strictEqual(merkle, BLOCK_100K.merkleRoot);
    });
  ...
  it('for testnet tx[9] block 350559', function () {
    ...
    var expMerkle = '5f14eb3b7ae064698e458cd75e3c40821688d4abe79cebded2f616495140ac56';
